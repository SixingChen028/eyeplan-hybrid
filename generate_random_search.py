...
def _write_training_log(run_dir: str, *, run_index: int, seed: int, elapsed_seconds: float, num_trials: int) -> None:
    ...
    with open(log_path, "a") as file:
        ...
        file.write(
            ...
            f"gamma_shape={RANDOM_SEARCH_STOP_GAMMA_SHAPE:.15g} "
            f"gamma_scale={RANDOM_SEARCH_STOP_GAMMA_SCALE:.15g} "
